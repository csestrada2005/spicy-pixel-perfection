...
export function Hero() {
  ...
  return (
    ...
    >
      ...
      {/* Fruit explosion backdrop (code-native) */}
      <HeroBackdrop />
      ...
      {/* ===== MAIN GRID ===== */}
      <div className="relative z-[15] mx-auto grid max-w-[1280px] grid-cols-1 gap-12 px-5 pt-28 pb-24 md:grid-cols-2 md:gap-10 md:px-8 md:pt-36 md:pb-4">
        {/* LEFT COLUMN */}
        ...
        <div className="relative hidden md:block">
          <div className="animate-fade-in flex flex-col items-center" style={{ animationDelay: "0.4s" }}>
            {heroPicks.map((p, i) => {
              ...
              const yShift = i === 4 ? "translate-y-26" : "";
              return (
                <div
                  key={p.id}
